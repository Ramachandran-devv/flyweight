...
class DocumentFont {
    constructor(family, style, size, color) {
        this.family = family;
        this.style = style;
        this.size = size;
        this.color = color;
...
class DocumentFontFactory {
    ...
    getFont(family, style, size, color) {
...
(function (DocumentEditor) {
    class TextDocument {
        constructor(content, family, style, size, color, fontFactory) {
    ...
    DocumentEditor.TextDocument = TextDocument;
